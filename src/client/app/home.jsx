...
class Home extends Component {
    ...
    render(){
        return (<div>
                  ...
                  <div className="headline main" onClick={this.redirect('try_dresses_headline')}>New Looks picked for You</div>
                  ...
                  <div className="button-container">
                    {<a id="cta" href="/fit-profile?from=get_started" className="btn"><span>Shop now</span></a>}
                  </div>
